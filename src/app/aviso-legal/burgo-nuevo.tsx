...
export default function AvisoLegalBurgoNuevo() {
  return (
    <main className="min-h-screen bg-background">
      <div className="container mx-auto max-w-4xl px-4 py-8">
        ...
        <div className="prose prose-gray max-w-none dark:prose-invert">
          <p className="mb-4">
            BARIGLE INVERSIONES SL, responsable del sitio web, en adelante
          ...
          <p className="mb-4">
            BARIGLE INVERSIONES SL se reserva el derecho de modificar cualquier
            ...
            publicación en el sitio web de BARIGLE INVERSIONES SL.
          </p>
          ...
          <section className="mb-8">
            ...
            <ul className="mb-4 space-y-2">
              <li>
                <strong>Nombre de dominio:</strong> www.inmo-bnuevo.com
              </li>
              <li>
                <strong>Nombre comercial:</strong> INMOBILIARIA BURGO NUEVO
              </li>
              <li>
                <strong>Denominación social:</strong> BARIGLE INVERSIONES SL
              </li>
              <li>
                <strong>NIF:</strong> B85850550
              </li>
              <li>
                <strong>Domicilio social:</strong> Arco de Ánimas 1 bajo, 24003
                León (LEON)
              </li>
              <li>
              ...
              <li>
                <strong>Email:</strong>{" "}
                <a
                  href="mailto:bnuevo@inmo-bnuevo.com"
                  className="transition-colors hover:text-primary"
                >
                  bnuevo@inmo-bnuevo.com
                </a>
              </li>
              <li>
                <strong>Inscrita en el Registro Mercantil:</strong> BARIGLE
                INVERSIONES SL — Registro Mercantil de León, Tomo 1340, Libro
                0, Folio 6, Sección 8ª, Hoja Registral LE25810
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              su programación, edición, compilación y demás elementos
              necesarios para su funcionamiento, los diseños, logotipos, texto
              y/o gráficos, son propiedad del RESPONSABLE o, si es el caso,
              dispone de licencia o autorización expresa por parte de los
              autores. Todos los contenidos del sitio web se encuentran
              debidamente protegidos por la normativa de propiedad intelectual
              e industrial, así como inscritos en los registros públicos
              correspondientes.
            </p>
            <p className="mb-4">
              ...
              comercialización, requiere en todo caso de la autorización
              escrita previa por parte del RESPONSABLE. Cualquier uso no
              autorizado previamente se considera un incumplimiento grave de
              los derechos de propiedad intelectual o industrial del autor.
            </p>
            <p className="mb-4">
              Los diseños, logotipos, texto y/o gráficos ajenos al RESPONSABLE
              ...
              sitio web, y en todo caso redirigir al sitio web principal de
              www.inmo-bnuevo.com.
            </p>
            <p className="mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              esta información haya sido manipulada o introducida por un
              tercero ajeno al mismo.
            </p>

            <h3 className="mb-3 text-xl font-semibold">Uso de Cookies</h3>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              donde se encuentra la web reconozca el navegador utilizado por el
              usuario con la finalidad de que la navegación sea más sencilla,
              permitiendo, por ejemplo, el acceso de los usuarios que se hayan
              registrado previamente a las áreas, servicios, promociones o
              concursos reservados exclusivamente a ellos sin tener que
              registrarse en cada visita. También se pueden utilizar para medir
              la audiencia, parámetros de tráfico, controlar el progreso y
              número de entradas, etc., siendo en estos casos cookies
            ...
            <h3 className="mb-3 text-xl font-semibold">Política de enlaces</h3>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              los artículos 11 y 16 de la LSSICE, se pone a disposición de
              todos los usuarios, autoridades y fuerzas de seguridad,
              colaborando de forma activa en la retirada o, en su caso, bloqueo
              de todos aquellos contenidos que puedan afectar o contravenir la
            ...
            <p className="mb-4">
              ...
              embargo, el RESPONSABLE no descarta la posibilidad de que existan
              ciertos errores de programación, o que acontezcan causas de
              fuerza mayor, catástrofes naturales, huelgas o circunstancias
              semejantes que hagan imposible el acceso a la página web.
            </p>

            <h3 className="mb-3 text-xl font-semibold">Direcciones IP</h3>
            <p className="mb-4">
              ...
              ordenador cuando éste se conecta a Internet. Toda esta
              información es registrada en un fichero de actividad del servidor
              debidamente inscrito que permite el posterior procesamiento de
              los datos con el fin de obtener mediciones únicamente
              estadísticas que permitan conocer el número de impresiones de
              páginas, el número de visitas realizadas a los servidores web, el
              orden de visitas, el punto de acceso, etc.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              que se someten expresamente las partes, siendo competentes para
              la resolución de todos los conflictos derivados o relacionados
              con su uso los Juzgados y Tribunales más cercanos a León.
            </p>
          </section>
        </div>
      </div>
